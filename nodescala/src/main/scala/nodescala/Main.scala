...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val myServerSubscription = myServer.start("/test")(_.keysIterator)
    ...
    val userInterrupted: Future[String] =
      Future.userInput("Enter your message :") map {
        case str => "You have entered..." + str
      }
    ...
    val terminationRequested: Future[String] = 
      Future.any(List(
          Future.delay(10 seconds) continue(_ =>"Shutdown!"),
          userInterrupted))
